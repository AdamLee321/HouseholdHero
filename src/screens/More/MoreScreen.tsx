    ...
    <View style={styles.container}>
      ...
      {family && (
        <View style={styles.familyCard}>
          ...
          <Text style={styles.inviteHint}>Share this code with family members to join</Text>
        </View>
      )}
...
const styles = StyleSheet.create({
  ...
  familyName: {color: '#fff', fontSize: 20, fontWeight: '700', marginBottom: 12},
  inviteLabel: {color: 'rgba(255,255,255,0.7)', fontSize: 12, fontWeight: '600', letterSpacing: 1, marginBottom: 4},
  inviteCode: {color: '#fff', fontSize: 32, fontWeight: '800', letterSpacing: 8},
  inviteHint: {color: 'rgba(255,255,255,0.6)', fontSize: 12, marginTop: 8, textAlign: 'center'},
  row: {
    backgroundColor: '#fff',
