      ...
      <TouchableOpacity
        ...
        style={[
          styles.choreRow,
          {
            ...
            borderLeftColor: STATUS_COLORS[chore.status],
          },
        ]}
      ...
      >
        ...
        <View style={styles.choreRight}>
          <View
            style={[
              styles.statusBadge,
              { backgroundColor: STATUS_COLORS[chore.status] + '22' },
            ]}
          >
            <Text
              style={[
                styles.statusText,
                { color: STATUS_COLORS[chore.status] },
              ]}
            >
              {chore.status.replace('_', ' ')}
            </Text>
          </View>
          <Text style={[styles.points, { color: colors.textTertiary }]}>
            +{EFFORT_POINTS[chore.effort]}pt
          </Text>
        </View>
      </TouchableOpacity>
    );
