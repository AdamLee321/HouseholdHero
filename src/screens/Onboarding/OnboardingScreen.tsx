...
export default function OnboardingScreen() {
  ...
  async function handleCreate() {
    ...
    try {
      ...
      setFamily(family);
      setProfile({uid: family.createdBy, displayName, email: null, familyId: family.id});
    } catch (e: any) {
  ...
  return (
    <KeyboardAvoidingView
      ...
      <ScrollView contentContainerStyle={styles.inner} keyboardShouldPersistTaps="handled">
        ...
        <Text style={[styles.title, {color: colors.text}]}>Welcome to HouseholdHero</Text>
...
const styles = StyleSheet.create({
  ...
  tabs: {flexDirection: 'row', marginBottom: 24, borderRadius: 10, padding: 4},
