...
export const DEFAULT_TILE_ACCESS: TileAccess = {
  parent:   ['Shopping', 'Todos', 'Chores', 'Calendar', 'Messages', 'Contacts', 'Location', 'Documents', 'MyFamily', 'Budget', 'Gallery', 'Recipes', 'Activity', 'MealPlanner', 'Timetable', 'SpecialDays'],
  guardian: ['Shopping', 'Todos', 'Chores', 'Calendar', 'Messages', 'Contacts', 'Location', 'Documents', 'Gallery', 'Recipes', 'Activity', 'MealPlanner', 'Timetable', 'SpecialDays'],
  child:    ['Shopping', 'Todos', 'Chores', 'Calendar', 'Messages', 'Gallery', 'Recipes', 'Activity', 'MealPlanner', 'Timetable', 'SpecialDays'],
};
